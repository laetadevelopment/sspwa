<template>
  <div v-if="showHome" id="home" class="page">
    ...
    <div class="page-content">
      <h3>The mission of the SSPWA (Single Screen Progressive Web App) Template is to create a progressive web app experience that feels like interacting with a movie.</h3>
